...
**Conversion Details**:
- Original file: `strategy/EXECUTIVE-BRIEF.md`
- AGI Farm role: `EXECUTIVE-BRIEF`
- AGI Farm category: `leadership`
- Color theme: `cyan`
...
# → Choose "Unknown Agent"

# Or use directly in workspace
cp templates/agency-agents/strategy/EXECUTIVE-BRIEF.md \
