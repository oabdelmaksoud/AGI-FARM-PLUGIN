...
**Conversion Details**:
- Original file: `project-management/project-manager-senior.md`
- AGI Farm role: `senior-pm`
...
# → Choose "Senior Project Manager"

# Or use directly in workspace
cp templates/agency-agents/project-management/project-manager-senior.md \
