...
**Conversion Details**:
- Original file: `project-management/project-management-studio-producer.md`
- AGI Farm role: `studio-producer`
...
# → Choose "Studio Producer"

# Or use directly in workspace
cp templates/agency-agents/project-management/project-management-studio-producer.md \
