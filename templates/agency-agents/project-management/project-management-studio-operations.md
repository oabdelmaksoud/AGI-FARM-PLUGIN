...
**Conversion Details**:
- Original file: `project-management/project-management-studio-operations.md`
- AGI Farm role: `operations-manager`
- AGI Farm category: `project-management`
- Color theme: `green`
...
# → Choose "Studio Operations"

# Or use directly in workspace
cp templates/agency-agents/project-management/project-management-studio-operations.md \
