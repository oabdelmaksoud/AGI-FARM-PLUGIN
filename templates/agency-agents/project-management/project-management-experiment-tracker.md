...
**Conversion Details**:
- Original file: `project-management/project-management-experiment-tracker.md`
- AGI Farm role: `experiment-manager`
...
cp templates/agency-agents/project-management/project-management-experiment-tracker.md \
