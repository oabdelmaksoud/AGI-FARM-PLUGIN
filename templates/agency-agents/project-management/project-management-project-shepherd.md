...
**Conversion Details**:
- Original file: `project-management/project-management-project-shepherd.md`
- AGI Farm role: `project-coordinator`
...
# → Choose "Project Shepherd"

# Or use directly in workspace
cp templates/agency-agents/project-management/project-management-project-shepherd.md \
