...
**Conversion Details**:
- Original file: `design/design-brand-guardian.md`
- AGI Farm role: `brand-manager`
...
# → Choose "Brand Guardian"

# Or use directly in workspace
cp templates/agency-agents/design/design-brand-guardian.md \
