...
**Conversion Details**:
- Original file: `design/design-whimsy-injector.md`
- AGI Farm role: `ux-enhancer`
...
# → Choose "Whimsy Injector"

# Or use directly in workspace
cp templates/agency-agents/design/design-whimsy-injector.md \
