...
**Conversion Details**:
- Original file: `design/design-image-prompt-engineer.md`
- AGI Farm role: `image-engineer`
- AGI Farm category: `design`
- Color theme: `amber`
...
# → Choose "Image Prompt Engineer"

# Or use directly in workspace
cp templates/agency-agents/design/design-image-prompt-engineer.md \
