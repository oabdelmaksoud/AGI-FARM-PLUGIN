...
**Conversion Details**:
- Original file: `design/design-visual-storyteller.md`
- AGI Farm role: `visual-designer`
...
# → Choose "Visual Storyteller"

# Or use directly in workspace
cp templates/agency-agents/design/design-visual-storyteller.md \
