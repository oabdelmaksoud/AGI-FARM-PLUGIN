...
**Conversion Details**:
- Original file: `engineering/engineering-mobile-app-builder.md`
- AGI Farm role: `mobile-developer`
- AGI Farm category: `engineering`
- Color theme: `purple`
...
# → Choose "Mobile App Builder"

# Or use directly in workspace
cp templates/agency-agents/engineering/engineering-mobile-app-builder.md \
