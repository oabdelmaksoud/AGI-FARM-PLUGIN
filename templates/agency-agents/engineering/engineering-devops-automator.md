...
**Conversion Details**:
- Original file: `engineering/engineering-devops-automator.md`
- AGI Farm role: `devops-engineer`
...
# → Choose "DevOps Automator"

# Or use directly in workspace
cp templates/agency-agents/engineering/engineering-devops-automator.md \
