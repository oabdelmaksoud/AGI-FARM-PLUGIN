...
**Conversion Details**:
- Original file: `engineering/engineering-rapid-prototyper.md`
- AGI Farm role: `prototyper`
...
# → Choose "Rapid Prototyper"

# Or use directly in workspace
cp templates/agency-agents/engineering/engineering-rapid-prototyper.md \
