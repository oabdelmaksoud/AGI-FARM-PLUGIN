...
**Conversion Details**:
- Original file: `engineering/engineering-backend-architect.md`
- AGI Farm role: `backend-architect`
...
# → Choose "Backend Architect"

# Or use directly in workspace
cp templates/agency-agents/engineering/engineering-backend-architect.md \
