...
**Conversion Details**:
- Original file: `spatial-computing/terminal-integration-specialist.md`
- AGI Farm role: `terminal-integration-specialist`
...
# → Choose "Terminal Integration Specialist"

# Or use directly in workspace
cp templates/agency-agents/spatial-computing/terminal-integration-specialist.md \
