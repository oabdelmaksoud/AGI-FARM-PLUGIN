...
**Conversion Details**:
- Original file: `spatial-computing/macos-spatial-metal-engineer.md`
- AGI Farm role: `macos-spatial-metal-engineer`
- AGI Farm category: `specialized`
- Color theme: `metallic-blue`
...
# → Choose "macOS Spatial/Metal Engineer"

# Or use directly in workspace
cp templates/agency-agents/spatial-computing/macos-spatial-metal-engineer.md \
