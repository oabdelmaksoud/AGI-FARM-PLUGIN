...
**Conversion Details**:
- Original file: `testing/testing-performance-benchmarker.md`
- AGI Farm role: `performance-engineer`
- AGI Farm category: `quality-assurance`
- Color theme: `orange`
...
# → Choose "Performance Benchmarker"

# Or use directly in workspace
cp templates/agency-agents/testing/testing-performance-benchmarker.md \
