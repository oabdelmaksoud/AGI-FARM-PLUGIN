...
**Conversion Details**:
- Original file: `testing/testing-evidence-collector.md`
- AGI Farm role: `qa-engineer`
...
# → Choose "Evidence Collector"

# Or use directly in workspace
cp templates/agency-agents/testing/testing-evidence-collector.md \
