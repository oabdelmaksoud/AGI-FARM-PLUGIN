...
**Conversion Details**:
- Original file: `testing/testing-tool-evaluator.md`
- AGI Farm role: `tech-evaluator`
...
# → Choose "Tool Evaluator"

# Or use directly in workspace
cp templates/agency-agents/testing/testing-tool-evaluator.md \
