...
**Conversion Details**:
- Original file: `testing/testing-reality-checker.md`
- AGI Farm role: `qa-lead`
...
# → Choose "Reality Checker"

# Or use directly in workspace
cp templates/agency-agents/testing/testing-reality-checker.md \
