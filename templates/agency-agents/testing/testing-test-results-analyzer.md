...
**Conversion Details**:
- Original file: `testing/testing-test-results-analyzer.md`
- AGI Farm role: `test-analyst`
...
# → Choose "Test Results Analyzer"

# Or use directly in workspace
cp templates/agency-agents/testing/testing-test-results-analyzer.md \
