...
**Conversion Details**:
- Original file: `testing/testing-workflow-optimizer.md`
- AGI Farm role: `process-engineer`
...
# → Choose "Workflow Optimizer"

# Or use directly in workspace
cp templates/agency-agents/testing/testing-workflow-optimizer.md \
