...
**Conversion Details**:
- Original file: `marketing/marketing-social-media-strategist.md`
- AGI Farm role: `social-strategist`
...
# → Choose "Social Media Strategist"

# Or use directly in workspace
cp templates/agency-agents/marketing/marketing-social-media-strategist.md \
