...
**Conversion Details**:
- Original file: `marketing/marketing-twitter-engager.md`
- AGI Farm role: `social-media-manager`
...
# → Choose "Twitter Engager"

# Or use directly in workspace
cp templates/agency-agents/marketing/marketing-twitter-engager.md \
