...
**Conversion Details**:
- Original file: `marketing/marketing-app-store-optimizer.md`
- AGI Farm role: `aso-specialist`
...
# → Choose "App Store Optimizer"

# Or use directly in workspace
cp templates/agency-agents/marketing/marketing-app-store-optimizer.md \
