...
**Conversion Details**:
- Original file: `product/product-feedback-synthesizer.md`
- AGI Farm role: `user-researcher`
- AGI Farm category: `product`
- Color theme: `blue`
...
# → Choose "Feedback Synthesizer"

# Or use directly in workspace
cp templates/agency-agents/product/product-feedback-synthesizer.md \
