...
**Conversion Details**:
- Original file: `product/product-sprint-prioritizer.md`
- AGI Farm role: `product-manager`
...
# → Choose "Sprint Prioritizer"

# Or use directly in workspace
cp templates/agency-agents/product/product-sprint-prioritizer.md \
