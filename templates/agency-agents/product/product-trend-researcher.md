...
**Conversion Details**:
- Original file: `product/product-trend-researcher.md`
- AGI Farm role: `market-researcher`
...
# → Choose "Trend Researcher"

# Or use directly in workspace
cp templates/agency-agents/product/product-trend-researcher.md \
