...
**Conversion Details**:
- Original file: `support/support-executive-summary-generator.md`
- AGI Farm role: `executive-assistant`
- AGI Farm category: `support`
- Color theme: `purple`
...
# → Choose "Executive Summary Generator"

# Or use directly in workspace
cp templates/agency-agents/support/support-executive-summary-generator.md \
