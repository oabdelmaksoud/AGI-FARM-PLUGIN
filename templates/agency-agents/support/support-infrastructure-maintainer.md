...
**Conversion Details**:
- Original file: `support/support-infrastructure-maintainer.md`
- AGI Farm role: `infrastructure-engineer`
...
# → Choose "Infrastructure Maintainer"

# Or use directly in workspace
cp templates/agency-agents/support/support-infrastructure-maintainer.md \
