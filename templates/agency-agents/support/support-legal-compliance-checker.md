...
**Conversion Details**:
- Original file: `support/support-legal-compliance-checker.md`
- AGI Farm role: `compliance-officer`
...
# → Choose "Legal Compliance Checker"

# Or use directly in workspace
cp templates/agency-agents/support/support-legal-compliance-checker.md \
