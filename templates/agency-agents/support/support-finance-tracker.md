...
**Conversion Details**:
- Original file: `support/support-finance-tracker.md`
- AGI Farm role: `finance-analyst`
...
# → Choose "Finance Tracker"

# Or use directly in workspace
cp templates/agency-agents/support/support-finance-tracker.md \
