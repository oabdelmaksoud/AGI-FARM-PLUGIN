...
**Conversion Details**:
- Original file: `support/support-analytics-reporter.md`
- AGI Farm role: `data-analyst`
...
# → Choose "Analytics Reporter"

# Or use directly in workspace
cp templates/agency-agents/support/support-analytics-reporter.md \
