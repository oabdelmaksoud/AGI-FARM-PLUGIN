...
**Conversion Details**:
- Original file: `support/support-support-responder.md`
- AGI Farm role: `support-engineer`
...
# → Choose "Support Responder"

# Or use directly in workspace
cp templates/agency-agents/support/support-support-responder.md \
