...
**Conversion Details**:
- Original file: `specialized/lsp-index-engineer.md`
- AGI Farm role: `lsp-index-engineer`
...
# → Choose "LSP/Index Engineer"

# Or use directly in workspace
cp templates/agency-agents/specialized/lsp-index-engineer.md \
