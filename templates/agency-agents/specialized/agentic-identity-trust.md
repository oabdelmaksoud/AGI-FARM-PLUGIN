...
**Conversion Details**:
- Original file: `specialized/agentic-identity-trust.md`
- AGI Farm role: `agentic-identity-trust`
...
cp templates/agency-agents/specialized/agentic-identity-trust.md \
