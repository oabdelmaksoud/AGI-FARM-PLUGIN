...
**Conversion Details**:
- Original file: `specialized/report-distribution-agent.md`
- AGI Farm role: `report-distribution-agent`
...
# → Choose "Report Distribution Agent"

# Or use directly in workspace
cp templates/agency-agents/specialized/report-distribution-agent.md \
