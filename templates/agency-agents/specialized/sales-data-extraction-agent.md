...
**Conversion Details**:
- Original file: `specialized/sales-data-extraction-agent.md`
- AGI Farm role: `sales-data-extraction-agent`
...
# → Choose "Sales Data Extraction Agent"

# Or use directly in workspace
cp templates/agency-agents/specialized/sales-data-extraction-agent.md \
