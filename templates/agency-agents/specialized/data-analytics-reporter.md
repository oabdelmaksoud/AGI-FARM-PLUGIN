...
**Conversion Details**:
- Original file: `specialized/data-analytics-reporter.md`
- AGI Farm role: `data-analytics-reporter`
...
# → Choose "Data Analytics Reporter"

# Or use directly in workspace
cp templates/agency-agents/specialized/data-analytics-reporter.md \
